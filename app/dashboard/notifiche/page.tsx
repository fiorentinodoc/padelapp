...
export default function NotifichePage() {
  ...
  async function handleSend() {
    ...
    setSuccess('Notifica salvata nel log! In produzione verrà inviata via push agli alunni.')
  ...
  return (
    <div style={{ padding: '32px', fontFamily: 'system-ui', color: '#fff' }}>
      ...
      {/* Invio manuale */}
      <div style={{ background: '#161b27', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '16px', padding: '24px', marginBottom: '28px', maxWidth: '600px' }}>
